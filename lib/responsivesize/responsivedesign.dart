import 'package:task5/responsivesize/constants.dart';
...
void main() {
  StdFontSize stdFontSize=StdFontSize(screenwidth:375);
  print(stdFontSize.small);
  print(stdFontSize.medium);
  print(stdFontSize.large);
}